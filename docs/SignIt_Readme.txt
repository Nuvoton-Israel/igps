 ...
 * Requirements
	...
	2) compilation tools
		...
		-Linux:
			g++ 4.6.3 and up.
		-Windows:
			Microsoft Visual Studio 2010 / Microsoft .NET Framework 4
			
 * Installation
	- Linux:
		copy the content of the project to a selected directory.
		source build.sh from <signIt dir>/linux_build.
	- Windows:
		copy the content of the project to a selected directory.
		run Production_Windows.bat
